                        ...
                        <div class="top-header-content d-flex align-items-center justify-content-between">
                            ...
                            <div class="top-breaking-news-area">
                                <div id="breakingNewsTicker" class="ticker">
                                    <ul>
                                        <li><a href="#">Stránky s články o zdraví!</a></li>
                                    </ul>
                                </div>
                            </div>
        ...
        <div class="container h-100">
            <div class="row h-100 align-items-center">
                ...
                <div class="col-12 col-md-4">
                    <h3 style="text-transform: capitalize">Podmínky a ustanovení</h3>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="index.php">Hlavní stránka</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Podmínky a ustanovení</li>
                        </ol>
                    </nav>
                </div>
                        ...
                        <div class="treading-articles-widget mb-70">
                            ...
                            <div class="single-blog-post style-4">
                                ...
                                <div class="post-data">
                                    ...
                                    <div class="post-meta">
                                        <p class="post-author"><a href="">Chasity</a></p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="footer-widget-area">
                            ...
                            <div class="single-blog-post style-2 d-flex align-items-center">
                                ...
                                <div class="post-data">
                                    ...
                                    <div class="post-meta">
                                        <p class="post-date"><a href="">17.06.2020</a></p>
                                    </div>
                                </div>
                            </div>
